...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', isLoading, children, className, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-accent-primary hover:bg-blue-600 text-white focus:ring-accent-primary',
      ...
      danger: 'bg-accent-danger hover:bg-red-600 text-white focus:ring-accent-danger',
